    ...
    <section className="app1 about bg-theme">
                    ...
                    <Row className="set-padding">
                        <Col sm="6" className="counters">
                            <div className="abouts">
                                <div>
                                    <Image alt="" className="service-img img-fluid"
                                        src="/assets/images/app_landing1/about/Ellipse-3-copy.png" width={"100%"} height={"100%"}/>
                        ...
                        <Col sm="6" className="counters">
                            <div className="abouts">
                                <div>
                                    <Image alt="" className="service-img img-fluid"
                                        src="/assets/images/app_landing1/about/close.png" width={"100%"} height={"100%"}/>
                        ...
                        <Col sm="6" className="counters">
                            <div className="abouts">
                                <div>
                                    <Image alt="" className="service-img img-fluid"
                                        src="/assets/images/app_landing1/about/love.png" width={"100%"} height={"100%"}/>
                        ...
                        <Col sm="6" className="counters">
                            <div className="abouts">
                                <div>
                                    <Image alt="" className="service-img img-fluid"
                                        src="/assets/images/app_landing1/about/coffee.png" width={"100%"} height={"100%"}/>
        ...
        <div className="set-abs mobile mobile-img bottom-0">
            <div className="set-relative">
                <Image alt="" className="img-fluid mobile-screen" src="/assets/images/app_landing1/about/1-1.png" width={"100%"} height={"100%"}/>
                <div className="set-abs mobile rectangle r-2  center-content bottom-0">
                    <Image alt="" className="img-fluid" src="/assets/images/app_landing1/icons/1-2.png" width={"100%"} height={"100%"}/>
                </div>
                <div className="set-abs mobile rectangle center-content bottom-0">
                    <Image alt="" className="img-fluid" src="/assets/images/app_landing1/Ellipse-2-copy-241.png" width={"100%"} height={"100%"}/>
                </div>
                <div className="set-abs mobile center-content galaxy bottom-0">
                    <Image alt="" className="img-fluid" src="/assets/images/app_landing1/about/Layer-27.png" width={"100%"} height={"100%"}/>
                </div>
            </div>
        </div>
    </section>

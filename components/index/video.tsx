                        ...
                        <div className="center-content">
                            <div className="video w-100">
                                <a className="button center-content" onClick={toggle}>
                                    <Image alt="video" className="img-fluid" src="/assets/images/app_landing1/playl-1.png" width={"100%"} height={"100%"}/>
                                </a>
                            </div>
                            <Modal isOpen={modal} toggle={toggle} centered={true} size="lg">
                                <ModalHeader toggle={toggle} className="modal-no-header close-up"></ModalHeader>
                                <ModalBody className="iframe-modal">
                                    <iframe className="mfp-iframe" frameBorder="0" allowFullScreen={false} src="//www.youtube.com/embed/dNIfsv1rKJo?autoplay=1"></iframe>
                                </ModalBody>
                            </Modal>
                        </div>
                    </Col>

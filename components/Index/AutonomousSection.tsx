    ...
    >
      ...
      <div className="container">
        <div className="row mt-2">
          ...
          >
            <div>
              ...
              <div className="f-medium">
                <p>
                  Artificial intelligence is changing the way we live our lives; it is everywhere
                  and here to stay. In 2021 we took part in the The NJord - Autonomous Ship
                  Challenge. It&apos;s a unique, international student competition, where
                  participants are tasked with designing and building an autonomous ship.
                </p>
                <p>
                  This first edition was fully digital and we achieved an incredible second place.
                  This is a big step to one of our future goals: to develop an autonomous vessel, so
                  that we can test our boats without the risk of harming the pilot!
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            className={cx("col-md align-items-center justify-content-center z-inf", {
              "d-flex": !toggleMl,
            })}
          >

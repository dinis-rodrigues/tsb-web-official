          ...
          <div className="text-center justify-content-center row">
            <div className="col-lg-10 z-inf">
              ...
              <p className="f-medium">
                Técnico Solar Boat is a project consisting of cross-degree engineering students from
                Instituto Superior Técnico, Portugal that work together on the development of a
                solar, hydrogen and autonomous boat.
              </p>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="item-card p-3" onMouseOver={() => setActiveDep("es")}>
              <div className="icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-info">
                <IoBulbOutline className="icon-lg" />
                {/* <SiAtom className="icon-lg" /> */}
              </div>
              <h5 className="text-white mt-2 text-shadow index-subheader">Electrical Systems</h5>
              <p className="department-description mt-2 text-shadow">
                Energy management, hydrofoils control system, dual motor system, telemetry, database
                and autonomous driving with machine learning models.
              </p>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="item-card p-3" onMouseOver={() => setActiveDep("ms")}>
              <div className="icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-info ">
                <FaCogs className="icon-lg" />
              </div>
              <h5 className="text-white mt-2 text-shadow index-subheader">Mechanical Systems</h5>
              <p className="department-description mt-2 text-shadow">
                Design, simulation and production of the hydro-foil struts, transmission system,
                propulsion column and custom trailer.
              </p>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="item-card p-3" onMouseOver={() => setActiveDep("dc")}>
              <div className="icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-info">
                <GiAnchor className="icon-lg" />
              </div>
              <h5 className="text-white mt-2 text-shadow index-subheader">Design and Composites</h5>
              <p className="department-description mt-2 text-shadow">
                Design, simulation and production of every composite made component.
              </p>
            </div>
          </div>
          <div className="col-lg-2"></div>
          <div className="col-lg-4">
            <div className="item-card p-3" onMouseOver={() => setActiveDep("mm")}>
              <div className="icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-info">
              ...
              <p className="department-description mt-2 text-shadow">
                Business endeavors. Resource acquisition and allocation. Business contracts.
              </p>
            </div>
          </div>
          <div className="col-lg-4">

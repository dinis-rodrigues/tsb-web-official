      ...
      <div className="container">
        <div className="mt-2 text-center justify-content-center row">
          <div className="col-lg-10">
            <h4 className="display-6 f-700 text-white">SÃO RAFAEL 01</h4>
            ...
            <p className="f-medium text-white">
              ...
              models and much more of SR 01. If you have any questions, send us
              a message! We will gladly reply!
            </p>
            <ClapButton
          ...
          <div className="col">
            <div className="item-card p-3">
              ...
              <ul className="opensource-list">
                ...
                <li className="onsource-list-item">Live Data Acquisition</li>

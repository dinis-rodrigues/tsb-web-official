...
import { getGalleryList, getGalleryPhotos } from "../components/Gallery/galleryUtils";
...
const Gallery: NextPage = () => {
  ...
  useEffect(() => {
    if (activeGallery)
      getGalleryPhotos(activeGallery, galleryList, galleryPhotos, setGalleryInfo, setGalleryPhotos);
      ...
      <Controller>
        ...
        >
          {(progress: 0 | 1) => {
            ...
            return (
              <Navbar theme={progress} hideFooter={progress === 0} isOpaque={progress === 1} />
            );
          }}
        </Scene>
        <div id="triggerEl">
          <div className="flex mx-5 justify-center">
            <div className="row nav-margin">
              ...
              <div className="col-sm-12 col-md-6" style={{ minHeight: "120vh" }}>
                {Object.hasOwn(galleryPhotos, activeGallery) &&
                Object.entries(galleryPhotos[activeGallery]).length > 0 ? (
                  ...
                  >
                    {Object.entries(galleryPhotos[activeGallery]).map(([photoId, photoInfo]) => (
                      <a
                      ...
                      >
                        <div className="gallery-item cursor-pointer">
                          <div className="gallery-image">
                            <img src={photoInfo.rzImgPath} alt={photoInfo.description} />
                          </div>
                        </div>
                      </a>
                    ))}
